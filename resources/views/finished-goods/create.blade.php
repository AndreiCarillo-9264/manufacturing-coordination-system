...
document.addEventListener('DOMContentLoaded', () => {
    ...
    $productSelect.on('select2:select', function(e) {
        ...
        if (selectedOption.id) {
            ...
            $('#selling_price').val($selectedElement.data('selling-price') || '0.00');
            $('#currency').val($selectedElement.data('currency') || 'PHP');
    ...
    if (selectedOption.val()) {
        ...
        $('#selling_price').val(selectedOption.data('selling-price') || '0.00');
        $('#currency').val(selectedOption.data('currency') || 'PHP');
    }
